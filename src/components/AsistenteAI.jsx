...
- **Entradas económicas** (/entradas): kanban de ingresos y proyectos (trabajos, empresas, freelance) por unidad; monto, detalles, proyección, objetivos (checklist con monto), tareas, mes y fecha objetivo; columnas editables.
