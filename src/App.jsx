    ...
    <div className="flex h-screen bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-100 font-sans overflow-hidden">
      ...
      <aside className={`fixed inset-y-0 left-0 z-30 w-72 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transform transition-transform duration-300 ease-in-out flex flex-col ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0`}>
        ...
        <div className="px-4 py-2 space-y-1">
          ...
          <Link to="/entradas" className="w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 group" title="Trabajos, empresas y freelance"><LayoutGrid size={18} className="text-gray-400 dark:text-gray-500 group-hover:text-indigo-500 shrink-0" /><span className="leading-tight"><span className="block">Entradas</span><span className="block text-[10px] font-normal text-gray-400 dark:text-gray-500">económicas</span></span></Link>
